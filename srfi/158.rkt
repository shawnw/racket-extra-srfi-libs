...
(provide
 (contract-out
  ...
  [string->generator (->* (string?) (exact-nonnegative-integer? exact-nonnegative-integer?) (-> char?))]
  [bytevector->generator (->* (bytes?) (exact-nonnegative-integer? exact-nonnegative-integer?) (-> byte?))]
  ...
  [gmerge (->* ((-> any/c any/c any/c) (-> any/c)) () #:rest (-> any/c) (-> any/c))]
  [gmap (->* (procedure? (-> any/c)) () #:rest (-> any/c) (-> any/c))]
  [gcombine (->* (procedure? any/c (-> any/c)) () #:rest (-> any/c) (-> any/c))]
  ...
  [generator->string (->* ((-> char?)) (exact-nonnegative-integer?) string?)]
  [generator-fold (->* (procedure? any/c (-> any/c)) () #:rest (-> any/c) any)]
  [generator-for-each (->* (procedure? any/c (-> any/c)) () #:rest (-> any/c) any)]
  [generator-map->list (->* (procedure? (-> any/c)) () #:rest (-> any/c) list?)]
  ...
  [generator-unfold (->* ((-> any/c) procedure?) () #:rest any/c any)]
  ...
  ;; SRFI-221
  [gcompose-left (->* ((-> (-> any/c))) () #:rest (-> (-> any/c) (-> any/c)) (-> any/c))]
  [gcompose-right (->* ((-> (-> any/c) (-> any/c))) () #:rest (-> (-> any/c)) (-> any/c))]
  [accumulate-generated-values (-> (-> any/c) (-> any/c any) any)]
  [genumerate (-> (-> any/c) (-> (cons/c exact-positive-integer? any/c)))]
  [gchoice (->* ((-> exact-nonnegative-integer?)) () #:rest (-> any/c) (-> any/c))]
