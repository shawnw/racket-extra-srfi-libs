...
(provide (all-from-out "base.rkt")
         ...
         (contract-out
          ...
          (fxvector-fold (-> procedure? any/c fxvector? fxvector? ... any/c))
          (fxvector-fold-right
           (-> procedure? any/c fxvector? fxvector? ... any/c))
          (fxvector-map (-> procedure? fxvector? fxvector? ... fxvector?))
          (fxvector-map! (-> procedure? fxvector? fxvector? ... fxvector?))
          (fxvector-for-each (-> procedure? fxvector? fxvector? ... void?))
          (fxvector-count
           (-> procedure? fxvector? fxvector? ... exact-nonnegative-integer?))
          ...
          (fxvector-skip-right
           (->
            ...
            ...
            (or/c exact-nonnegative-integer? #f)))
          (fxvector-any (-> procedure? fxvector? fxvector? ... any))
          (fxvector-every (-> procedure? fxvector? fxvector? ... any))
          (fxvector-partition
           (->
            (-> fx? any/c)
            fxvector?
...
(module+
 ...
 (test-group
  ...
  (test-group
   ...
   (test-equiv "partition" '(1 3 5 2 4) (fxvector-partition odd? s5))
