...
(provide (all-from-out "base.rkt")
         ...
         (contract-out
          ...
          (c64vector-fold (-> procedure? any/c c64vector? c64vector? ... any/c))
          (c64vector-fold-right
           (-> procedure? any/c c64vector? c64vector? ... any/c))
          (c64vector-map (-> procedure? c64vector? c64vector? ... c64vector?))
          (c64vector-map! (-> procedure? c64vector? c64vector? ... c64vector?))
          (c64vector-for-each (-> procedure? c64vector? c64vector? ... void?))
          (c64vector-count
           (-> procedure? c64vector? c64vector? ... exact-nonnegative-integer?))
          (c64vector-cumulate
          ...
          (c64vector-skip-right
           (->
            ...
            ...
            (or/c exact-nonnegative-integer? #f)))
          (c64vector-any (-> procedure? c64vector? c64vector? ... any))
          (c64vector-every (-> procedure? c64vector? c64vector? ... any))
          (c64vector-partition
           (->
            (-> c64? any/c)
            c64vector?
