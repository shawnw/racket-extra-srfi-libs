...
(define (in-s64vector vec (start 0) (end (s64vector-length vec)))
  (make-do-sequence
   (lambda ()
     (values
      (lambda (i) (s64vector-ref vec i))
      #f
      add1
      start
      (lambda (i) (< i end))
 ...
 (test-group
  ...
  (test-group
   ...
   (test-equiv
    ...
    '(1 3 5 2 4)
    (call-with-values
     (lambda () (s64vector-partition odd? s5))
     (lambda (vec cnt) vec)))
