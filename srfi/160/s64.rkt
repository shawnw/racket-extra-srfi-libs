...
(provide (all-from-out "base.rkt")
         ...
         (contract-out
          ...
          (s64vector-fold (-> procedure? any/c s64vector? s64vector? ... any/c))
          (s64vector-fold-right
           (-> procedure? any/c s64vector? s64vector? ... any/c))
          (s64vector-map (-> procedure? s64vector? s64vector? ... s64vector?))
          (s64vector-map! (-> procedure? s64vector? s64vector? ... s64vector?))
          (s64vector-for-each (-> procedure? s64vector? s64vector? ... void?))
          (s64vector-count
           (-> procedure? s64vector? s64vector? ... exact-nonnegative-integer?))
          (s64vector-cumulate
          ...
          (s64vector-skip-right
           (->
            ...
            ...
            (or/c exact-nonnegative-integer? #f)))
          (s64vector-any (-> procedure? s64vector? s64vector? ... any))
          (s64vector-every (-> procedure? s64vector? s64vector? ... any))
          (s64vector-partition
           (->
            (-> s64? any/c)
            s64vector?
