...
(provide (all-from-out "base.rkt")
         ...
         (contract-out
          ...
          (s8vector-fold (-> procedure? any/c s8vector? s8vector? ... any/c))
          (s8vector-fold-right
           (-> procedure? any/c s8vector? s8vector? ... any/c))
          (s8vector-map (-> procedure? s8vector? s8vector? ... s8vector?))
          (s8vector-map! (-> procedure? s8vector? s8vector? ... s8vector?))
          (s8vector-for-each (-> procedure? s8vector? s8vector? ... void?))
          (s8vector-count
           (-> procedure? s8vector? s8vector? ... exact-nonnegative-integer?))
          ...
          (s8vector-skip-right
           (->
            ...
            ...
            (or/c exact-nonnegative-integer? #f)))
          (s8vector-any (-> procedure? s8vector? s8vector? ... any))
          (s8vector-every (-> procedure? s8vector? s8vector? ... any))
          (s8vector-partition
           (->
            (-> s8? any/c)
            s8vector?
