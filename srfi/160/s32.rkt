...
(define (in-s32vector vec (start 0) (end (s32vector-length vec)))
  (make-do-sequence
   (lambda ()
     (values
      (lambda (i) (s32vector-ref vec i))
      #f
      add1
      start
      (lambda (i) (< i end))
 ...
 (test-group
  ...
  (test-group
   ...
   (test-equiv
    ...
    '(1 3 5 2 4)
    (call-with-values
     (lambda () (s32vector-partition odd? s5))
     (lambda (vec cnt) vec)))
