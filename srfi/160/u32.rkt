...
(provide (all-from-out "base.rkt")
         ...
         (contract-out
          ...
          (u32vector-fold (-> procedure? any/c u32vector? u32vector? ... any/c))
          (u32vector-fold-right
           (-> procedure? any/c u32vector? u32vector? ... any/c))
          (u32vector-map (-> procedure? u32vector? u32vector? ... u32vector?))
          (u32vector-map! (-> procedure? u32vector? u32vector? ... u32vector?))
          (u32vector-for-each (-> procedure? u32vector? u32vector? ... void?))
          (u32vector-count
           (-> procedure? u32vector? u32vector? ... exact-nonnegative-integer?))
          (u32vector-cumulate
          ...
          (u32vector-skip-right
           (->
            ...
            ...
            (or/c exact-nonnegative-integer? #f)))
          (u32vector-any (-> procedure? u32vector? u32vector? ... any))
          (u32vector-every (-> procedure? u32vector? u32vector? ... any))
          (u32vector-partition
           (->
            (-> u32? any/c)
            u32vector?
