...
(provide (all-from-out "base.rkt")
         ...
         (contract-out
          ...
          (f32vector-fold (-> procedure? any/c f32vector? f32vector? ... any/c))
          (f32vector-fold-right
           (-> procedure? any/c f32vector? f32vector? ... any/c))
          (f32vector-map (-> procedure? f32vector? f32vector? ... f32vector?))
          (f32vector-map! (-> procedure? f32vector? f32vector? ... f32vector?))
          (f32vector-for-each (-> procedure? f32vector? f32vector? ... void?))
          (f32vector-count
           (-> procedure? f32vector? f32vector? ... exact-nonnegative-integer?))
          (f32vector-cumulate
          ...
          (f32vector-skip-right
           (->
            ...
            ...
            (or/c exact-nonnegative-integer? #f)))
          (f32vector-any (-> procedure? f32vector? f32vector? ... any))
          (f32vector-every (-> procedure? f32vector? f32vector? ... any))
          (f32vector-partition
           (->
            (-> f32? any/c)
            f32vector?
