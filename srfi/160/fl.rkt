...
(provide (all-from-out "base.rkt")
         ...
         (contract-out
          ...
          (flvector-fold (-> procedure? any/c flvector? flvector? ... any/c))
          (flvector-fold-right
           (-> procedure? any/c flvector? flvector? ... any/c))
          (flvector-map (-> procedure? flvector? flvector? ... flvector?))
          (flvector-map! (-> procedure? flvector? flvector? ... flvector?))
          (flvector-for-each (-> procedure? flvector? flvector? ... void?))
          (flvector-count
           (-> procedure? flvector? flvector? ... exact-nonnegative-integer?))
          ...
          (flvector-skip-right
           (->
            ...
            ...
            (or/c exact-nonnegative-integer? #f)))
          (flvector-any (-> procedure? flvector? flvector? ... any))
          (flvector-every (-> procedure? flvector? flvector? ... any))
          (flvector-partition
           (->
            (-> fl? any/c)
            flvector?
